...
module.exports = {
	...
	targets: {
		'./bin/index.js':       { template: 'bin/index.js' },
		'./lib/index.js':       { template: 'lib/index.js' },
		'./lib/before.js':      { template: 'lib/before.js' },
		...
		'./templates/README.md':{ template: 'templates/README.md' },
